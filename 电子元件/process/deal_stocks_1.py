...
for file_name in file_names:
    ...
    if balance_sheet_name and "计算公式" in workbook.sheetnames:
        ...
        if asset_row and liability_row and stock_row:
            for i in range(1, 6):
                ...
                if value1 != '-' and value1 != '--' and value2 != '-' and value2 != '--' and value3 != '-' and value3 != '--' and value3 != 0:
                    try:
                        # 计算除法
    ...
    if income_sheet_name and "计算公式" in workbook.sheetnames:
        ...
        if total_profit_row and operating_cost_row and sell_fee_row and management_fee_row and RD_fee_row:
            for i in range(1, 6):
                ...
                if value1 != '-' and value1 != '--' and value2 != '-' and value2 != '--' and value3 != '-' and value3 != '--' and value4 != '-' and value4 != '--' and value5 != '-' and value5 != '--':
                    try:
                        # 计算除法
    ...
    if cash_flow_sheet_name and "计算公式" in workbook.sheetnames:
        ...
        if results_cash_13_copy['总资产周转率'] and results_cash_15_copy['权益乘数'] and results_cash_16_copy['销售净利率']:
            for i in range(1, 6):
                ...
                if value1 != '-' and value1 != '--' and value2 != '-' and value2 != '--' and value3 != '-' and value3 != '--':
                    try:
                        # 计算除法
    ...
    if income_sheet_name and "成本收入比率" in workbook.sheetnames:
        ...
        if total_operating_costs:
            for i in range(1, 6):
                value1 = total_operating_costs[i] if total_operating_costs[i] is not None else '-'
                if value1 != '-' and value1 != '--' and value1 != 0:
                    try:
                        # 计算除法
                        result = float(value1)
        ...
        if results_temp_operating_income_copy and results_cost_income_1 and results_cost_income_2 and results_cost_income_3 and results_cost_income_4 and results_cost_income_5:
            for i in range(5):
                ...
                if value1 != '-' and value1 != '--' and value2 != '-' and value2 != '--' and value3 != '-' and value3 != '--' and value4 != '-' and value4 != '--' and value5 != '-' and value5 != '--' and value6 != '-' and value6 != '--':
                    try:
                        # 计算除法
    ...
    cost_income_sheet['G16'] = float(sum(results_income_12['所得税率'])) / float(len(results_income_12['所得税率'])) if all(isinstance(item, (float, int)) for item in results_income_12['所得税率']) else '-'
